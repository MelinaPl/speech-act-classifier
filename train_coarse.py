...
model = AutoModelForSequenceClassification.from_pretrained("dbmdz/bert-base-german-uncased", num_labels=6, id2label=ids_to_labels, label2id=labels_to_ids).to(device)
